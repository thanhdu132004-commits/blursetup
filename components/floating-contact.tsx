...
export function FloatingContact() {
  ...
  // =================================================================
  const ZALO_PHONE = "0912345678"; // <-- Điền SĐT Zalo (Viết liền)
  const FACEBOOK_LINK = "https://m.me/mixigaming"; // <-- Điền link Messenger
  // =================================================================
  ...
  return (
    <div className="fixed bottom-24 right-4 md:bottom-8 md:right-8 z-[100]" ref={menuRef}>
      ...
      >
        ...
        {/* NÚT AI CHAT (Chờ phát triển) */}
        <button 
          onClick={() => alert("Trợ lý AI BlurBot đang được đào tạo và sẽ sớm ra mắt!")}
        ...
        >
          <span className="px-3 py-1.5 bg-gray-900 text-white text-xs font-bold rounded-lg shadow-md transition-all whitespace-nowrap opacity-100 md:opacity-0 md:group-hover:opacity-100">
            Hỏi AI BlurBot (Sắp có)
          </span>
          <div className="w-12 h-12 bg-gradient-to-tr from-purple-600 to-indigo-500 rounded-full flex items-center justify-center text-white shadow-lg group-hover:scale-110 transition-transform">
